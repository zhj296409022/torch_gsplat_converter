...
def main():
  ...
  parser.add_argument('--device', type=str, default='cuda', help='Run on CUDA instead of CPU.')
  ...
  if args.task == 'ply2sog':
    ply2sog(str(input_path), str(output_path), args.kmeans_iterations, device=device)
